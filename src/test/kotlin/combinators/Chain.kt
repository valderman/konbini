...
class Chain {
    ...
    @Test
    fun `chain succeeds on empty chain`() {
    ...
    @Test
    fun `chain parses comma-separated lists properly`() {
    ...
    @Test
    fun `chain parses singleton lists properly`() {
    ...
    @Test
    fun `chainr is right-associative`() {
